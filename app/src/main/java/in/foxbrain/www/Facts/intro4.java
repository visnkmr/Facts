...
public class intro4 extends Activity {
   ImageView introslide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desc.setMovementMethod(new ScrollingMovementMethod());
        first.startAnimation(AnimationUtils.loadAnimation(getApplicationContext(),android.R.anim.fade_in));
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                if (e1.getX() < e2.getX()) {
                    if(first.getText().toString().equalsIgnoreCase( begin))
                    {
                        ...
                        desc.startAnimation(AnimationUtils.loadAnimation(getApplicationContext(),android.R.anim.fade_in));
                        introslide.setImageResource(imageId[0]);
                        introslide.setVisibility(View.VISIBLE);
                        introslide.startAnimation(AnimationUtils.loadAnimation(getApplicationContext(),android.R.anim.fade_in));
                    }
